...
func (c *Commands) defaultCommands() []*CommandItem {
	commands := []*CommandItem{
		...
		NewCommandItem(c.com.Styles, "switch_mode", "Switch Agent Mode", "", ActionOpenDialog{ModesID}),
	}
	...
	commands = append(commands,
		...
		NewCommandItem(c.com.Styles, "webdav_config", "Configure WebDAV Sync", "", ActionOpenWebDAVConfig{}),
		NewCommandItem(c.com.Styles, "agui_config", "Configure AGUI Server", "", ActionOpenAguiConfig{}),
